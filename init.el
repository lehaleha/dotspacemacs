...
values."
  (setq-default
   ...
   ;; or `spacemtacs'. (default 'spacemacs)
...
you should place your code here."
  ...
  ;; What to display in modeline when clocked-in (try current/today?)
